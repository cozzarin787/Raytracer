...
Phong matGlass = Phong(colorGlass, specColorGlass, 0.0f, 0.0f, 1.0f, 1.0f);
...
Phong matMirror = Phong(colorMirror, specColorMirror, 0.0f, 0.66f, 0.33f, 1.0f);
...
int main()
{
	...
	// Create LightSources
	Point lightPoint1 = Point(-2.0f, 2.0f, -11.0f);
