...
Phong matGlass = Phong(colorGlass, specColorGlass, 0.33f, 0.33f, 0.33f, 0.5f);
Point centerGlass = Point(-0.121f, 1.014f, -4.724f);
float radiusGlass = 1.2988f;

// Mirror Sphere
Color colorMirror = Color(0, 0, 1);
Color specColorMirror = Color(2, 2, 2);
Phong matMirror = Phong(colorMirror, specColorMirror, 0.33f, 0.33f, 0.33f, 0.5f);
...
Phong matFloor = Phong(colorFloor, specColorFloor, 0.33f, 0.33f, 0.33f, 0.5f);
...
Phong matTri = Phong(colorTri, specColorFloor, 0.33f, 0.33f, 0.33f, 0.5f);
Point p0 = Point(-2.7f, -1, -10);
Point p1 = Point(-2.7f, -1, 20);
Point p2 = Point(9, -1, 20);

Color colorTri2 = Color(1, 0, 0);
Phong matTri2 = Phong(colorTri2, specColorFloor, 0.33f, 0.33f, 0.33f, 0.5f);
Point p3 = Point(9, -1, 20);
Point p4 = Point(9, -1, -10);
Point p5 = Point(-2.7f, -1, -10);

Color colorTri3 = Color(1, 0, 0);
Phong matTri3 = Phong(colorTri3, specColorFloor, 0.33f, 0.33f, 0.33f, 0.5f);
...
int main()
{
	...
	Triangle t3 = Triangle(m6, p6, p7, p8);
	...
	// Create LightSources
	Point lightPoint1 = Point(-0.121f, 2.0f, -3.0f);
	LightSource l1 = LightSource(lightPoint1, Color(10, 10, 10));
